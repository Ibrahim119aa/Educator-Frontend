...
import { registerParent } from "@/lib/API/Parent";
...
const StudentRegistrationForm = () => {
    ...
    return (
        <div className="border p-5 rounded-md">
            <h1 className="text-2xl font-semibold text-center pb-5">Register as a Parent</h1>
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-wrap">
                    <div className="flex-1 p-5 flex flex-col items-center justify-center min-w-[250px]">
                        <label className="h-40 w-40 border rounded-md cursor-pointer bg-slate-50 dark:bg-slate-900" htmlFor="image">
                            {
                                selectedImage ?
                                    <img className="h-40 w-40 object-cover rounded-md" src={selectedImage} alt="Selected Image" />  // @next/next/no-img-element
                                    :
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        ...
                                        ">
                                            <div>+91</div>
                                            <Input placeholder="1234567890" {...field} className="h-auto px-0 py-0 border-0 focus-visible:ring-0 bg-transparent ring-0" />
                                        </label>
                                    </FormControl>
                                    <FormDescription>
